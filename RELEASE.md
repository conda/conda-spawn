...
[compare]: https://github.com/conda/conda-spawn/compare
[new release]: https://github.com/conda/conda-spawn/releases/new
...
[Anaconda Recipes]: https://github.com/AnacondaRecipes/conda-spawn-feedstock
[conda-forge]: https://github.com/conda-forge/conda-spawn-feedstock
...
Placeholder for `conda-spawn MAJOR.MINOR.PATCH` release.
...
[milestone]: https://github.com/conda/conda-spawn/milestone/<milestone>
[process]: https://github.com/conda/conda-spawn/blob/main/RELEASE.md
[releases]: https://github.com/conda/conda-spawn/releases
[main]: https://github.com/AnacondaRecipes/conda-spawn-feedstock
[conda-forge]: https://github.com/conda-forge/conda-spawn-feedstock
[zulip]: https://conda.zulipchat.com/#narrow/channel/480811-releases
...
1. Clone and `cd` into the repository if you haven't done so already:
    ...
    ```bash
    $ git clone git@github.com:/conda-spawn.git
    $ cd conda-spawn
    ```
